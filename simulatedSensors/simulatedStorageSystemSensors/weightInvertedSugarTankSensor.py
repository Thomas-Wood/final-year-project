...
class weightInvertedSugarTankSensor(simulatedSensorTemplate.simulatedSensorTemplate):

    def firstTimeSetup(self):
        self.lastResultTime = datetime.datetime.now()
        self.lastResult = 18000  # 18 Tonnes of extract in the tank
        self.usePerSecond = 0.11  # 0.11 Kg used per second
        self.refillRatePerSecond = 4  # Tanker fills silo at 5 kg per second
